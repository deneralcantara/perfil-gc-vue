<template>
    <div class="header-blue border py-5">
        ...
        <div class="row align-items-center px-3">
                ...
                <div class="row">
                    <div class="text-white" v-for="(expertise, index) in profile.data.expertiseProgress" :key="expertise.key">
                        <div class="row px-4 mx-4 pb-2">
                            <div v-if="index % 2 == 0">
                                {{expertise.label}}
                                <img :style="profile.data.player.expertise >= expertise.limit ? null : 'filter: grayscale(100%);-webkit-filter: grayscale(100%);'" src="../../assets/images/blue_pin.png">
                            </div>
                        </div> 
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="text-white" v-for="(expertise, index) in profile.data.expertiseProgress" :key="expertise.key">
                        <div class="col-md-12 px-4 mx-4 pt-1">
                            <div v-if="index % 2 == 1">
                                <img :style="profile.data.player.expertise >= expertise.limit ? null : 'filter: grayscale(100%);-webkit-filter: grayscale(100%);'" class="rotate90" src="../../assets/images/blue_pin.png">
                                {{expertise.label}}
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-3 text-right">
                <img class="border-blue" :src="profile.data.featuredMedal.image">
            </div>
        </div>
        ...
        <div class="row second-line align-items-center mt-3 pt-0 mx-0 px-0">
            ...
            <div class="col-md-4 card-height px-0 mx-0 border-separate">
                ...
                <div class="row justify-content-center mt-2 py-3 my-2 px-0 mx-0">
                    <!-- PARTIDAS -->
                    <div class="col-md-3 mx-1 card-gc">
                        <span class="matches_ranked_blue">{{profile.data.ranked.matches}}</span>
                        <p class="title">Partidas</p>
                    </div>
                ...
                <div class="col-md-12">
                    <button class="btn btn-ranked-blue btn-block text-white"><img class="mr-2" width="20" src="../../assets/images/users.svg"> ENTRAR NA FILA</button>
                </div>
            </div>
    ...
    export default {
        ...
        methods : {
            ...
            getImage: async function(){
                await this.$store.dispatch('getImage', this.$route.params.id, this.userimage);
            },
